    ...
    <>
      <main>
        <section className="block" id="about">
          ...
          <h1 className="font-lead text-heading-1">Sambhav Sharma</h1>
          <p className="text-body-1">Full Stack Engineer · Systems Architect</p>
          <div className="about">
            <p>
        ...
        <DataBlock id="case-study" title="Case Study">
          <div className="block">
            <h3>AI Personalization System · BOLD</h3>
