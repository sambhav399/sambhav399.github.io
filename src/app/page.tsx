  ...
  return (
    <main>
      <section className="block" id="about">
        <span className="block-title hidden">About</span>
        ...
        <div className="about">
          <p className="about-point">
            I design and scale high-performance systems, combining engineering,
            architecture, and research to drive measurable product impact.
          </p>
          <p className="about-point">
            I build distributed systems and high-scale applications with a focus
            on performance, reliability, and clean architecture.
          </p>
          <p className="about-point">
            At BOLD, I lead engineering efforts across system design,
            personalization platforms, and performance optimization - delivering
          ...
          <p className="about-point">
            I focus on building systems that scale without increasing complexity
            - prioritizing performance, reliability, and clear architecture over
            quick fixes.
          </p>
        </div>
      ...
      <DataBlock id="work" title="Experience">
        ...
        <div className="experience">
          <div className="experience-header">
            <div className="experience-title">
              Lead Full Stack Developer | CareerDose
            </div>
            <div className="experience-duration">2019 — 2022</div>
          </div>
          <p className="experience-summary">
            Built and scaled multi-platform applications across web, mobile, and
            desktop
          </p>
          <ul className="experience-body data-list">
            <li>
      ...
      <DataBlock id="research" title="Research">
        <ul className="data-list">
          ...
          <li>Built evaluation pipelines to measure ATS parsing performance</li>
          <li>
